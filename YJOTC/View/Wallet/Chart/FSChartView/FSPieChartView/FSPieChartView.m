...
//            UIColor *newColor = [UIColor colorWithRed:r green:g blue:b alpha:a / 2];
            ...
            UIBezierPath *path = [UIBezierPath bezierPathWithArcCenter:center radius:_outerCircleRadius + 0 startAngle:self.sectionPercentages[section][@"start"].floatValue endAngle:self.sectionPercentages[section][@"end"].floatValue clockwise:YES];
