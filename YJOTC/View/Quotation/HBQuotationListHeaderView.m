...
- (void)awakeFromNib {
    ...
    [self.nameButton setTitle:kLocat(@"HBQuotationListHeaderView_name") forState:UIControlStateNormal];
    [self.priceButton setTitle:kLocat(@"HBQuotationListHeaderView_Latest price") forState:UIControlStateNormal];
    [self.changeOf24HButton setTitle:kLocat(@"HBQuotationListHeaderView_24h change") forState:UIControlStateNormal];
}
