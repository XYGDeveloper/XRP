...
//    self.likeButton.contentEdgeInsets = UIEdgeInsetsMake(0, 0, 0, 25);
    ...
    self.likeButton.imageEdgeInsets = UIEdgeInsetsMake(0,-1, 0, 0);
    self.likeButton.contentEdgeInsets = UIEdgeInsetsMake(0, 4, 0, 0);
    ...
    _attentionButton.SG_eventTimeInterval = 0.8;
    ...
    _likeButton.SG_eventTimeInterval = 0.8;
