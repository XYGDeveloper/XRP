...
- (void)refreshWithParams:(NSDictionary *)params {
    ...
    [dic safeSetObject:@(self.pageSize) forKey:@"page_size"];
    [dic safeSetObject:[NSString stringWithFormat:@"%ld",time] forKey:@"sign__time"];
    NSString *sign =  [Utilities handleParamsWithDic:dic];
    [dic safeSetObject:sign forKey:@"sign"];
