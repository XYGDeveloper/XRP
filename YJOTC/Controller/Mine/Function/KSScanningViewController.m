...
//    }];
    ...
    UIBarButtonItem *rbbItem = [[UIBarButtonItem alloc]initWithTitle:kLocat(@"W_album") style:UIBarButtonItemStyleDone target:self action:@selector(alumbBtnEvent)];
...
//            AudioServicesPlaySystemSound(soundID);
        ...
        UIAlertView * alertView = [[UIAlertView alloc]initWithTitle:@"提示" message:@"該圖片沒有包含壹個二維碼！" delegate:nil cancelButtonTitle:@"確定" otherButtonTitles:nil, nil];
        [alertView show];
    }
}
