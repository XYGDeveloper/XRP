...
-(void)setupUI
{
    UIView *navView = [[UIView alloc] initWithFrame:kRectMake(0, 0, kScreenW, kNavigationBarHeight)];
    navView.backgroundColor = kNewBgColor;
    ...
    HXSearchBar *searchBar = [[HXSearchBar alloc] initWithFrame:CGRectMake(42, y, kScreenW -  42 - 12, 34)];
    ...
    searchBar.centerY = self.backBtn.centerY;
    ...
    [deleteButton addBlockForControlEvents:UIControlEventTouchUpInside block:^(id  _Nonnull sender) {
        ...
        [weakSelf.fallView reloadAllWithTitles:nil];
    }];
