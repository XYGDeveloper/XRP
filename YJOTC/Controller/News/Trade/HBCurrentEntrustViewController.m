...
//    self.title = self.model.comcurrencyName;
    ...
    [self.selectBtn setTitleColor:kWhiteColor forState:UIControlStateNormal];
    [self.selectBtn setImage:kImageFromStr(@"hq_icon_time") forState:UIControlStateNormal];
    self.myTitleLabel.textColor = k222222Color;
//    [self.selectBtn setTitleColor:k666666Color forState:UIControlStateNormal];
}
