...
@interface XPXPRDetailViewController ()<ZJScrollPageViewDelegate>
@property (nonatomic, strong) ZJScrollPageView *scrollPageView;
@property(nonatomic,strong)NSArray *titles;

@end

@implementation XPXPRDetailViewController
...
-(void)setupUI
{
    self.title = kLocat(@"hz_xrp_detail");
...
- (UIViewController<ZJScrollPageViewChildVcDelegate> *)childViewController:(UIViewController<ZJScrollPageViewChildVcDelegate> *)reuseViewController forIndex:(NSInteger)index {
    ...
    XPXRPDetialListViewController<ZJScrollPageViewChildVcDelegate> *childVc = reuseViewController;
    
    if (!childVc) {
        childVc = [XPXRPDetialListViewController new];
    }
