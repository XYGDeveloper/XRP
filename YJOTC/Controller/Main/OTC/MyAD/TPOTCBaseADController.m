...
-(void)setupNavi
{
    ...
    [leftButton setBackgroundImage:[UIImage imageWithColor:kColorFromStr(@"1A7FAC")] forState:UIControlStateSelected];
    
    [leftButton setBackgroundImage:[UIImage imageWithColor:kNaviColor] forState:UIControlStateNormal];
    ...
    [rightButton setBackgroundImage:[UIImage imageWithColor:kColorFromStr(@"1A7FAC")] forState:UIControlStateSelected];
    
    [rightButton setBackgroundImage:[UIImage imageWithColor:kNaviColor] forState:UIControlStateNormal];
    rightButton.tag = 1;
