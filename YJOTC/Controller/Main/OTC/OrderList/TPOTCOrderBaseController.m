...
-(void)setupUI
{
    ...
    style.titleFont = PFRegularFont(13);
...
//    self.titles = @[@"全部",@"未付款",@"待放行",@"已取消",@"已完成",@"申訴中"];
    self.titles = @[kLocat(@"OTC_order_all"),kLocat(@"OTC_order_notpay"),kLocat(@"OTC_order_todischarge"),kLocat(@"OTC_order_cancel"),kLocat(@"OTC_order_done"),kLocat(@"OTC_order_applealing")];
