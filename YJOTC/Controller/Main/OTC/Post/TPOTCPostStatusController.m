...
//        tt = @"已提交申請，等待平台處理";
    ...
    UILabel *midLabel = [[UILabel alloc] initWithFrame:kRectMake(0, img.bottom + 9, kScreenW, 16) text:t font:PFRegularFont(16) textColor:k222222Color textAlignment:1 adjustsFont:YES];
    [self.view addSubview:midLabel];
    
    UILabel *bottomLabel = [[UILabel alloc] initWithFrame:kRectMake(0, img.bottom + 48, kScreenW, 12) text:tt font:PFRegularFont(12) textColor:k666666Color textAlignment:1 adjustsFont:YES];
