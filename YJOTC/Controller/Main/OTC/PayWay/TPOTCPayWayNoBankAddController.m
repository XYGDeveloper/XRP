...
//            pic.clipsToBounds = YES;
            ...
            if (indexPath.section == 1) {
                cell.tf.attributedPlaceholder = [[NSAttributedString alloc] initWithString:kLocat(@"k_popview_select_paywechat_name_placehoder") attributes:@{NSForegroundColorAttributeName: k999999Color}];
                _nameTF = cell.tf;
                _nameTF.userInteractionEnabled = NO;
                _nameTF.text = kUserInfo.userName;
            }else if (indexPath.section == 2){
                cell.tf.attributedPlaceholder = [[NSAttributedString alloc] initWithString:kLocat(@"k_popview_select_paywechat_accounter_placehoder") attributes:@{NSForegroundColorAttributeName: k999999Color}];
                _accountTF = cell.tf;
                if (_model) {
                    _accountTF.text = _model.cardnum;
                }
            }else if (indexPath.section == 3){
                cell.tf.attributedPlaceholder = [[NSAttributedString alloc] initWithString:kLocat(@"k_popview_select_paywechat_pwd_placehoder") attributes:@{NSForegroundColorAttributeName: k999999Color}];
