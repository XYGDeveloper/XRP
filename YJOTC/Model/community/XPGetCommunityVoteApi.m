...
@interface XPGetCommunityVoteApi()
@property (nonatomic,strong)NSString *key;
@property (nonatomic,strong)NSString *token_id;
@end
@implementation XPGetCommunityVoteApi
...
- (ApiCommand *)buildCommand {
    ...
    command.requestURLString = APIURL(@"/api/BossPlan/buy_step_list");
    return command;
}

- (id)reformData:(id)responseObject {
    NSArray *array = [outterModel mj_objectArrayWithKeyValuesArray:responseObject];
    return array;
}
