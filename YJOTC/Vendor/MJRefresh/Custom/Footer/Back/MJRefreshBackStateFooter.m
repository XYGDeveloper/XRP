...
//    [self setTitle:NSEaseLocalizedString(@"ui.downloadComplete", @"Download complete") forState:MJRefreshStateNoMoreData];
    // 初始化文字
    [self setTitle:kLocat(@"MJRefreshBackFooterIdleText") forState:MJRefreshStateIdle];
    [self setTitle:kLocat(@"MJRefreshBackFooterPullingText") forState:MJRefreshStatePulling];
    [self setTitle:kLocat(@"MJRefreshBackFooterRefreshingText") forState:MJRefreshStateRefreshing];
    [self setTitle:kLocat(@"MJRefreshBackFooterNoMoreDataText") forState:MJRefreshStateNoMoreData];
}
