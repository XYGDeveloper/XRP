...
//    [self setTitle:NSEaseLocalizedString(@"ui.downloadComplete", @"Download complete") forState:MJRefreshStateNoMoreData];
    [self setTitle:kLocat(@"R_NoMoreData") forState:MJRefreshStateNoMoreData];

    
    [self setTitle:kLocat(@"MJRefreshAutoFooterIdleText") forState:MJRefreshStateIdle];
    [self setTitle:kLocat(@"MJRefreshAutoFooterRefreshingText") forState:MJRefreshStateRefreshing];
    [self setTitle:kLocat(@"MJRefreshAutoFooterNoMoreDataText") forState:MJRefreshStateNoMoreData];
