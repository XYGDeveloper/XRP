...
- (void)setLastUpdatedTimeKey:(NSString *)lastUpdatedTimeKey
{
    ...
    if (lastUpdatedTime) {
        ...
        self.lastUpdatedTimeLabel.text = [NSString stringWithFormat:@"%@%@%@",
                                          kLocat(@"MJRefreshHeaderLastTimeText"),
                                          isToday ? kLocat(@"MJRefreshHeaderDateTodayText") : @"",
                                          time];
    } else {
        self.lastUpdatedTimeLabel.text = [NSString stringWithFormat:@"%@%@",
                                          kLocat(@"MJRefreshHeaderLastTimeText"),
                                          kLocat(@"MJRefreshHeaderNoneLastDateText")];
...
- (void)prepare
{
    ...
    // 初始化文字
    [self setTitle:kLocat(@"MJRefreshHeaderIdleText") forState:MJRefreshStateIdle];
    [self setTitle:kLocat(@"MJRefreshHeaderPullingText") forState:MJRefreshStatePulling];
    [self setTitle:kLocat(@"MJRefreshHeaderRefreshingText") forState:MJRefreshStateRefreshing];
