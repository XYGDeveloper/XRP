...
-(instancetype)initWithOrigin:(CGPoint)origin Width:(CGFloat)width Height:(float)height Direction:(WBArrowDirection)direction
{
    if (self = [super initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, SCREEN_HEIGHT)])
    {
        ...
        self.backView=[[UIView alloc]initWithFrame:CGRectMake(kScreenW -_width-15, origin.y+5, width, height)];
        ...
        [self.backView.layer setBorderWidth:0.5];
        [self.backView.layer setBorderColor:[[UIColor grayColor] CGColor]];
...
-(void)popView
{
    ...
    else if (_direction==WBArrowDirectionUp1)
    {
        ...
        [UIView animateWithDuration:0.2 animations:^{
            self.alpha = 1;
            self.backView.frame = CGRectMake(self.origin.x-20, self.origin.y+7, self.width,self. height);
        }completion:^(BOOL finished) {
    ...
    else if (_direction==WBArrowDirectionUp2)
    {
        ...
        [UIView animateWithDuration:0.2 animations:^{
            ...
            self.backView.frame = CGRectMake(kScreenW - 280-15, _origin.y+5, _width, _height);
